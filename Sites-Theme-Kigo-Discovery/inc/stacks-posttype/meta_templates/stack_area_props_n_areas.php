<?php
$StackPropsNAreas = new StackPropsNAreas();
...
<!-- The list of stack areas -->
<div class="stacks-sorting">
    ...
    <div class="sources">
      ...
      <div class="locations-list">
        <h3>Select Location(s):
            ...
            <select class="search-locations-select">
                ...
                <?php foreach($StackPropsNAreas->ma_types as $type):?>
                    <option value="<?php echo $type; ?>" class="<?php echo $type; ?>"><?php echo $type; ?></option>
                <?php endforeach; ?>
            </select>
        </h3>
          
          <!--Add new Stack Area Node-->
          <a href="#" class="button button-primary new-stack-node">New Stack Node</a>

        <div class="list">
          <ol class="stacks-tree ma-list-parent sortable sortable-group">
              <?php
                  echo $StackPropsNAreas->get_ma_items($StackPropsNAreas->locations);
              ?>
          </ol>
        </div>
      </div>
      ...
      <div class="properties-list">
        ...
        <div class="list">
          <ol class="stacks-tree prop-list-parent sortable sortable-group">
              <?php
                  echo $StackPropsNAreas->get_prop_items();
              ?>
          </ol>
        </div>
      </div>
    ...
    <div class="user-list">
      ...
      <h3>Stack Area:</h3>
      <div class="drop-here">
        <ol class="stacks-tree to-save sortable sortable-group">
        </ol>
      </div>
