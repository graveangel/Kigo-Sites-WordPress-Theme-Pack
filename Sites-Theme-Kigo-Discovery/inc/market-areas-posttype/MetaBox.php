...
class MetaBox {
    ...
    function __construct($args, $templatesPath='.') {
        ...
        //This rules to validate strings
        $this->rules = empty($args['rules']) ? [] : $args['rules'];
    ...
    /**
     * Checks if the passed string is secure depending on the
     * passed rules.
     * @param  array $rules  set of conditions / each rule is a regular expression that if the string matches then it is not secure
