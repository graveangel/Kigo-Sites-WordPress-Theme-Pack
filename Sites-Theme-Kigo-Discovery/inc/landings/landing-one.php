...
function landing_one_metaboxes() {
    ...
    $cmb->add_field( array(
        ...
        'id'   => $prefix . 'heroimg',
        'type' => 'file',
        'default' => $theme_url.'/kd-common/img/landings/hero-one.png',
    ) );
    ...
    $cmb->add_group_field( $items_group, array(
        ...
        'id'   => 'item_image',
        'type' => 'file',
        'default' => $theme_url.'/kd-common/img/landings/cutting-edge.png',
    ) );
...
<ul>
    ...
    $cmb->add_field(array(
        ...
        'type' => 'file',
        'default' => $theme_url.'/kd-common/img/landings/couch.png',
    ) );
    ...
    $cmb->add_field(array(
        ...
        'type' => 'file',
        'default' => $theme_url.'/kd-common/img/landings/kitchen.png',
    ) );
